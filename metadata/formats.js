 const Formats = [
	...
	},
	{
		...
		onValidateTeam(team, f, teamHas) {
			...
			for (const set of team) {
				const abilitySources = _optionalChain([teamHas, 'access', _ => _.abilitySources, 'optionalAccess', _2 => _2[this.dex.toID(set.species)]]);
	...
	},
	{
		...
		onModifySpecies(species, target, source) {
			if (source || !_optionalChain([target, 'optionalAccess', _3 => _3.side])) return;
			const god = target.side.team.find(set => {
				let godSpecies = this.dex.species.get(set.species);
				const isNatDex = _optionalChain([this, 'access', _4 => _4.format, 'access', _5 => _5.ruleTable, 'optionalAccess', _6 => _6.has, 'call', _7 => _7('standardnatdex')]);
	...
	},
	{
		...
		checkCanLearn(move, species, lsetData, set) {
			// @ts-ignore
			if (!_optionalChain([set, 'access', _8 => _8.sp, 'optionalAccess', _9 => _9.exists]) || !_optionalChain([set, 'access', _10 => _10.crossSpecies, 'optionalAccess', _11 => _11.exists])) {
		...
		validateSet(set, teamHas) {
			...
			let problems = _optionalChain([this, 'access', _12 => _12.dex, 'access', _13 => _13.formats, 'access', _14 => _14.get, 'call', _15 => _15('Pokemon'), 'access', _16 => _16.onChangeSet, 'optionalAccess', _17 => _17.call, 'call', _18 => _18(this, set, this.format)]) || null;
			...
			const item = this.dex.items.get(set.item);
			if (_optionalChain([item, 'access', _19 => _19.itemUser, 'optionalAccess', _20 => _20.length])) {
