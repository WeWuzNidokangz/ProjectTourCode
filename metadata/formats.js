 const Formats = [
	...
	},
	{
		...
		checkCanLearn(move, species, lsetData, set) {
			// @ts-ignore
			if (!_optionalChain([set, 'access', _ => _.sp, 'optionalAccess', _2 => _2.exists]) || !_optionalChain([set, 'access', _3 => _3.crossSpecies, 'optionalAccess', _4 => _4.exists])) {
		...
		validateSet(set, teamHas) {
			...
			let problems = _optionalChain([this, 'access', _5 => _5.dex, 'access', _6 => _6.formats, 'access', _7 => _7.get, 'call', _8 => _8('Pokemon'), 'access', _9 => _9.onChangeSet, 'optionalAccess', _10 => _10.call, 'call', _11 => _11(this, set, this.format)]) || null;
	...
	},
	{
		...
		onValidateTeam(team, f, teamHas) {
			...
			for (const set of team) {
				const abilitySources = _optionalChain([teamHas, 'access', _14 => _14.abilitySources, 'optionalAccess', _15 => _15[this.dex.toID(set.species)]]);
	...
	},
	{
		...
		validateSet(set, teamHas) {
			...
			if (_optionalChain([problem, 'optionalAccess', _16 => _16.length])) problems.push(...problem);
			set.item = itemStr;
			return problems;
		},
		onValidateTeam(team) {
	...
	},
	{
		...
		onValidateSet(set) {
			...
			if (species.baseSpecies === item.megaEvolves || (item.onPrimal && _optionalChain([item, 'access', _17 => _17.itemUser, 'optionalAccess', _18 => _18.includes, 'call', _19 => _19(species.baseSpecies)])) ||
		...
		pokemon: {
			...
			ignoringAbility() {
				...
				for (const pokemon of this.battle.getAllActive()) {
					// can't use hasAbility because it would lead to infinite recursion
					if (
						(pokemon.ability === ('neutralizinggas' ) || _optionalChain([pokemon, 'access', _20 => _20.m, 'access', _21 => _21.abils, 'optionalAccess', _22 => _22.includes, 'call', _23 => _23('ability:neutralizinggas')])) &&
						!pokemon.volatiles['gastroacid'] && !pokemon.abilityState.ending
					) {
						neutralizinggas = true;
						break;
				...
				return !!(
					...
					((this.volatiles['gastroacid'] ||
						(neutralizinggas && (this.ability !== ('neutralizinggas' ) ||
							_optionalChain([this, 'access', _24 => _24.m, 'access', _25 => _25.abils, 'optionalAccess', _26 => _26.includes, 'call', _27 => _27('ability:neutralizinggas')]))
	...
	},
	{
		...
		onSwitchIn(pokemon) {
			...
			if (_optionalChain([status, 'optionalAccess', _28 => _28.exists])) {
		...
		onFaint(target, source, effect) {
			if (_optionalChain([effect, 'optionalAccess', _29 => _29.effectType]) !== 'Move') return;
