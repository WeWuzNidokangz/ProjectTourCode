const Rulesets = {
	...
	crossevolutionmod: {
		...
		checkCanLearn(move, species, lsetData, set) {
			// @ts-ignore
			if (!_optionalChain([set, 'access', _15 => _15.sp, 'optionalAccess', _16 => _16.exists]) || !_optionalChain([set, 'access', _17 => _17.crossSpecies, 'optionalAccess', _18 => _18.exists])) {
		...
		validateSet(set, teamHas) {
			...
			let problems = _optionalChain([onChangeSet, 'optionalAccess', _19 => _19.call, 'call', _20 => _20(this, set, this.format)]) || null;
